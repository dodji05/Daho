        ...
        var h = {
            ...
            _scrollToActive: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                    e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 500, n = this.getLayoutMenu();
                if (n) {
                    ...
                    if (i) {
                        ...
                        var s = r.scrollTop, a = i - s - parseInt(r.clientHeight / 2, 10), u = +new Date;
                        if (!0 === t) {
                            var l = function t() {
                                var n = +new Date - u, i = o(n, s, a, e);
            ...
            _swipeOut: function (t, e) {
                ...
                if (void 0 !== n && "string" == typeof t) {
                    ...
                    if (i) {
                        var o = new n(i);
                        o.get("pan").set({direction: n.DIRECTION_ALL, threshold: 75}), o.on("panleft", e)
                    }
                }
            },
            ...
            _hasClass: function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.ROOT_EL, n = !1;
            ...
            _redrawLayoutMenu: function () {
                ...
                if (t && t.querySelector(".menu")) {
                    var e = t.querySelector(".menu-inner"), n = e.scrollTop, i = document.documentElement.scrollTop;
            ...
            _bindLayoutAnimationEndEvent: function (t, e) {
                var n = this, i = this.getMenu(), o = i ? this._getAnimationDuration(i) + 50 : 0;
            ...
            scrollPageTo: function (t) {
                ...
                var o = i.scrollTop, r = t - o, s = +new Date, a = function a() {
                    var u = +new Date - s, l = n(u, o, r, e);
                    i.scrollTop = l, u < e ? requestAnimationFrame(a) : i.scrollTop = t
                };
                a()
            },
            setCollapsed: function () {
                var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f("collapsed"),
                    n = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], i = this.getLayoutMenu();
            ...
            setAutoUpdate: function () {
                var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f("enable");
            ...
            on: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f("event"),
                    ...
                    n = t.split("."), r = o(n, 1), s = r[0], a = t.split("."), u = i(a), l = u.slice(1);
                l = l.join(".") || null, this._listeners.push({event: s, namespace: l, callback: e})
            },
            off: function () {
                var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f("event"),
                    n = e.split("."), r = o(n, 1), s = r[0], a = e.split("."), u = i(a), l = u.slice(1);
            ...
            initPasswordToggle: function () {
                ...
                null != t && t.forEach((function (t) {
                    t.addEventListener("click", (function (e) {
                        e.preventDefault();
                        var n = t.closest(".form-password-toggle"), i = n.querySelector("i"),
            ...
            initSidebarToggle: function () {
                document.querySelectorAll('[data-bs-toggle="sidebar"]').forEach((function (t) {
                    t.addEventListener("click", (function () {
                        var e = t.getAttribute("data-target"), n = t.getAttribute("data-overlay"),
