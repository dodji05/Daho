!function (t, e) {
    ...
    190: function (t, e) {
        ...
        var l = ["rtl", "style", "layoutType", "layoutMenuFlipped", "showDropdownOnHover", "layoutNavbarFixed", "layoutFooterFixed", "themes"],
            r = ["light", "dark"], c = document.documentElement.classList,
            u = document.getElementsByTagName("HTML")[0].getAttribute("data-theme") || 0,
            d = c.contains("dark-style") ? "dark" : "light", h = "rtl" === document.documentElement.getAttribute("dir"),
            m = !!c.contains("layout-menu-collapsed"), p = !!c.contains("layout-menu-flipped"),
            y = !!c.contains("layout-navbar-fixed"), f = !!c.contains("layout-footer-fixed"),
                ...
                return e = t, (s = [{
                    ...
                    key: "setLayoutType", value: function (t) {
                        ...
                        if (this._hasControls("layoutType") && ("static" === t || "static-offcanvas" === t || "fixed" === t || "fixed-offcanvas" === t)) {
                            ...
                            var s = window.Helpers.menuPsScroll, i = window.PerfectScrollbar;
                    ...
                    key: "setLang", value: function (e) {
                        ...
                        if (e !== this.settings.lang || i) {
                            ...
                            var o = t.LANGUAGES[e];
                            ["panel_header", "panel_sub_header", "themeing_header", "theme_header", "style_label", "style_switch_light", "style_switch_dark", "layout_header", "layout_label", "layout_static", "layout_offcanvas", "layout_fixed", "layout_fixed_offcanvas", "layout_flipped_label", "layout_dd_open_label", "layout_navbar_label", "layout_footer_label", "misc_header", "theme_label", "rtl_label"].forEach((function (t) {
                    ...
                    key: "_loadSettings", value: function () {
                        var t, e = this._getSetting("Rtl"), s = this._getSetting("Style"),
                            i = this._getSetting("LayoutCollapsed"), o = this._getSetting("LayoutMenuFlipped"),
                            a = this._getSetting("ShowDropdownOnHover"), n = this._getSetting("FixedNavbar"),
                            l = this._getSetting("FixedFooter"), r = this._getSetting("LayoutType");
                    ...
                    key: "_setup", value: function () {
                        ...
                        var i = this.container.querySelector(".template-customizer-open-btn"), a = function () {
                        ...
                        var n = this.container.querySelector(".template-customizer-close-btn"), l = function () {
                    ...
                    key: "_getSetting", value: function (t) {
                        var e = null, s = this._getLayoutName();
                        try {
        ...
        v.THEMES = [{name: "theme-default", title: "Default"}, {
            name: "theme-semi-dark",
            title: "Semi Dark"
        }, {name: "theme-bordered", title: "Bordered"}], v.LANGUAGES = {
            en: {
        ...
        var a = {insert: "head", singleton: !1}, n = (i(o, a), o.locals ? o.locals : {});
        t.exports = n
    }, 201: function (t, e, s) {
        ...
        function r(t, e) {
            for (var s = {}, i = [], o = 0; o < t.length; o++) {
                var a = t[o], r = e.base ? a[0] + e.base : a[0], c = s[r] || 0, u = "".concat(r, " ").concat(c);
                s[r] = c + 1;
                var d = l(u), h = {css: a[1], media: a[2], sourceMap: a[3]};
        ...
        function h(t, e, s, i) {
            ...
            if (t.styleSheet) t.styleSheet.cssText = d(e, o); else {
                var a = document.createTextNode(o), n = t.childNodes;
                n[e] && t.removeChild(n[e]), n.length ? t.insertBefore(a, n[e]) : t.appendChild(a)
            }
        }

        function m(t, e, s) {
            var i = s.css, o = s.media, a = s.sourceMap;
        ...
        function f(t, e) {
            ...
            if (e.singleton) {
                var a = y++;
                s = p || (p = c(e)), i = h.bind(null, s, a, !1), o = h.bind(null, s, a, !0)
            } else s = c(e), i = m.bind(null, s, e), o = function () {
                !function (t) {
