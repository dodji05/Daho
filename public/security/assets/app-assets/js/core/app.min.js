!function (o, r, p) {
    "use strict";
    var c = p("html"), u = p("body"), d = "#FF5B5C";
    if (p(o).on("scroll", function () {
        ...
        u.hasClass("menu-collapsed") && (a = !0), p("html").data("textdirection"), setTimeout(function () {
        ...
        !1 === p.app.nav.initialized && p.app.nav.init({speed: 300}), Unison.on("change", function (e) {
            p.app.menu.change(a)
        }), p('[data-toggle="tooltip"]').tooltip({container: "body"}), p(".tooltip-horizontal-bookmark").tooltip({customClass: "tooltip-horizontal-bookmark"}), p('a[data-action="collapse"]').on("click", function (e) {
            ...
            if (u.hasClass("dark-layout")) var a = "#10163a"; else a = "#fff";
            e.block({
        ...
        p(".custom-file input").change(function (e) {
            ...
            !function (e, a) {
                ...
                p(".char-count").html(e.value.length), e.value.length > n ? (p(".counter-value").css("background-color", d), p(".char-textarea").css("color", d), p(".char-textarea").addClass("max-limit")) : (p(".counter-value").css("background-color", "#5A8DEE"), p(".char-textarea").css("color", "#304156"), p(".char-textarea").removeClass("max-limit"))
    ...
    if (p(r).on("click", ".menu-toggle, .modern-nav-toggle", function (e) {
    ...
    }), "undefined" != typeof screenfull && screenfull.isEnabled && p(r).on(screenfull.raw.fullscreenchange, function () {
        ...
        var n = p("html")[0].lang;
        if (null !== n) {
            var t = p(".dropdown-language").find("a[data-language=" + n + "]").text(),
                s = p(".dropdown-language").find("a[data-language=" + n + "] .flag-icon").attr("class");
            p("#dropdown-flag .selected-language").text(t), p("#dropdown-flag .flag-icon").removeClass().addClass(s)
        }
    } else i18next.use(o.i18nextXHRBackend).init({
        debug: !1,
        fallbackLng: "en",
            ...
            if (p("ul.search-list li").remove(), p(this).parent().hasClass("bookmark-input") && (i = !0), "" != s) {
                ...
                p.getJSON("../../../app-assets/data/" + h + ".json", function (e) {
                    for (var a = 0; a < e.listItems.length; a++) {
                        ...
                        0 == e.listItems[a].name.toLowerCase().indexOf(s) && d < 10 && (l += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' + (0 === d ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + e.listItems[a].url + '><div class="d-flex justify-content-start"><span class="mr-75 ' + e.listItems[a].icon + '" data-icon="' + e.listItems[a].icon + '"></span><span>' + e.listItems[a].name + "</span></div>" + u + "</a></li>", d++)
                    }
                    for (a = 0; a < e.listItems.length; a++) {
                        ...
                        0 != e.listItems[a].name.toLowerCase().indexOf(s) && -1 < e.listItems[a].name.toLowerCase().indexOf(s) && d < 10 && (r += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' + (0 === d ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + e.listItems[a].url + '><div class="d-flex justify-content-start"><span class="mr-75 ' + e.listItems[a].icon + '" data-icon="' + e.listItems[a].icon + '"></span><span>' + e.listItems[a].name + "</span></div>" + u + "</a></li>", d++)
                    }
    ...
    errorPlacement: function (e, a) {
        a.parent().hasClass("input-group") || a.hasClass("select2") || "checkbox" === a.attr("type") ? e.insertAfter(a.parent()) : a.hasClass("custom-control-input") ? e.insertAfter(a.parent().siblings(":last")) : e.insertAfter(a), a.parent().hasClass("input-group") && a.parent().addClass("is-invalid")
    },
